---
{
  ...
  "status": "implemented",
  "owner": "autogrammar/code2schema",
  "created": "2026-09-06",
  "updated": "2026-09-06",
  "review_after": "2026-10-06",
  "source_revision": "0852f7a8c92bf943e4da1968941e03f72a9a4d71",
  "affected_repositories": [
    "autogrammar/code2schema"
  ],
  "evidence": [
...
Opis i tematy GitHub repozytorium `autogrammar/code2schema` synchronizuje koordynator `semcod/.github`.
...
```bash
gh workflow run org-metadata-sync.yml --repo semcod/.github --ref main -f repository=autogrammar/code2schema -f dry_run=true
```
